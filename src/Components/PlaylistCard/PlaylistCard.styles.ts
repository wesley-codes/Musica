...
${Mobile({flexDirection:"column", textAlign:"start", alignItems:"flex-start", marginLeft:"10px"})}
...
${Mobile({flexDirection:"column-reverse", textAlign:"start", alignItems:"flex-end", })}
